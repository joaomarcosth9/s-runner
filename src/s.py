...
try:
    ...
    if file_extension == 'cpp':
        if cpp_fast_compiling:
            ...
            command = 'g++ -std=c++17 -Wshadow -O2 -Wfatal-errors -Wall -Wextra -Wno-unused-result -Wno-unused-variable -fsanitize=address -fsanitize=undefined -fno-sanitize-recover -DLOCAL_DEBUG '
